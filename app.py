...
def draw_academic_risk_bar(model_name, subtitle_html, probability, is_dual_track=False):
    ...
    if prob_pct >= 50:
        bar_color, status_text = "#9F1239", "Display Category: ≥50%"
    elif prob_pct >= 30:
        bar_color, status_text = "#B45309", "Display Category: 30–<50%"
    else:
        bar_color, status_text = "#0D9488", "Display Category: <30%"
...
st.markdown('<div class="main-header">Precision CVD Risk Stratification: A Heterogeneity-Aware Dual-Track System</div>',
            unsafe_allow_html=True)
st.markdown(
    '<div class="sub-header">Interactive demonstration of gatekeeper-guided routing and model-specific risk estimates.</div>',
    unsafe_allow_html=True)
...
if gatekeeper is not None:
    ...
    if st.sidebar.button("🔍 Run Prediction", use_container_width=True, type="primary"):
        ...
        is_odkd_positive = gatekeeper.predict_proba(df_gate)[0][1] >= 0.532
...
<p style="margin: 0; color: #475569; font-size: 1.05rem; font-weight: 600;">Higher gatekeeper probability ➔ Routed to <b>Track A</b></p></div></div>"""
        else:
...
<span style="font-size: 1.8rem; margin-right: 15px;">🛡️</span>
<div><h5 style="margin: 0; color: #1E293B; font-weight: 800; font-size: 1.15rem;">Gatekeeper Triage Active</h5>
<p style="margin: 0; color: #475569; font-size: 1.05rem; font-weight: 600;">Lower gatekeeper probability ➔ Routed to <b>Track B</b></p></div></div>"""
...
<h3 style="color: #0F766E; margin: 0 0 4px 0; font-size: 1.35rem;">🟢 Downward Risk Reclassification</h3>
<p style="margin: 0; color: #115E59; font-size: 1.1rem; font-weight: 600; line-height: 1.3;">Risk estimate decreased below the 50% cutoff after Track A assignment.</p>
</div>"""
...
<h3 style="color: #881337; margin: 0 0 4px 0; font-size: 1.35rem;">🔴 Upward Risk Reclassification</h3>
<p style="margin: 0; color: #4C0519; font-size: 1.1rem; font-weight: 600; line-height: 1.3;">Risk estimate increased above the 50% cutoff after Track B assignment.</p>
</div>"""
