...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = './output/2_Model_Training_and_Evaluation/LightGBM/'
    ...
    print("Initializing LightGBM hyperparameter tuning via Grid Search...")

    # LightGBM handles missing values natively, so no Imputer is needed here.
    ...
    output_excel_path = os.path.join(OUTPUT_DIR, 'LightGBM_Evaluation_Metrics.xlsx')
    try:
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'LightGBM_ROC_Curve.pdf'), format='pdf', bbox_inches='tight')
    plt.close()
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'LightGBM_PR_Curve.pdf'), format='pdf', bbox_inches='tight')
    plt.close()
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'LightGBM_Confusion_Matrix.pdf'), format='pdf', bbox_inches='tight')
    plt.close()
